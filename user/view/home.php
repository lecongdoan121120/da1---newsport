        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="wrap-slider">
                    <img src="public/img/slider1.jpg" alt="fashion-slideshow">
                    <div class="box-content">
                        <div class="container">
                            <p class="fade-item fade-item-1 fw-8 mb_15">MUST HAVES</p>
                            <h1 class="fade-item fade-item-2 fw-8">WINTER SHOES</h1>
                            <a href="index.php?action=product" class="fade-item fade-item-3 tf-btn btn-fill animate-hover-btn btn-xl radius-3"><span>Xem chi tiết <i class="icon icon-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="wrap-slider">
                    <img src="public/img/slider2.jpg" alt="fashion-slideshow">
                    <div class="box-content">
                        <div class="container">
            ...
            <div class="swiper-slide">
                <div class="wrap-slider">
                    <img src="public/img/slider3.jpg" alt="fashion-slideshow">
                    <div class="box-content">
                        <div class="container">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="brand-item">
                        <img class="lazyload" data-src="" src="public/img/brand-01.png" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-item">
                        <img class="lazyload" data-src="" src="public/img/brand-02.png" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-item">
                        <img class="lazyload" data-src="" src="public/img/brand-03.png" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-item">
                        <img class="lazyload" data-src="" src="public/img/brand-04.png" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-item">
                        <img class="lazyload" data-src="" src="public/img/brand-05.png" alt="">
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="brand-item">
                        <img class="lazyload" data-src="" src="public/img/brand-06.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="masonry-layout-v4 wow fadeInUp" data-wow-delay="0s">
            <div class="item-1 collection-item-v2 hover-img">
                <a href="?action=product" class="collection-inner">
                    <div class="collection-image img-style">
                        <img class="lazyload" data-src="" src="public/img/sneaker-5.jpg" alt="">
                    </div>
                    <div class="collection-content">
                        <div class="top wow fadeInUp" data-wow-delay="0s">
                            <h5 class="heading text-white fw-7">SẢN PHẨM</h5>
                            <button class="tf-btn btn-line btn-line-light collection-other-link fw-6"><span>XEM CHI TIẾT</span><i class="icon icon-arrow1-top-left"></i></button>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a href=?action=product" class="collection-inner">
                    ...
                    <div class="collection-content justify-content-end">
                        <div class="bottom wow fadeInUp" data-wow-delay="0s">
                            <h5 class="heading text-white fw-7">GIÀY NỔI BẬT</h5>
                            <button class="tf-btn btn-line btn-line-light collection-other-link fw-6"><span>MUA NGAY</span><i class="icon icon-arrow1-top-left"></i></button>
                        </div>
                    </div>
                </a>
            </div>
            <div class="item-3 collection-item-v2 hover-img">
                <a href=?action=product" class="collection-inner">
                    ...
                    <div class="collection-content justify-content-end">
                        <div class="bottom wow fadeInUp" data-wow-delay="0s">
                            <h5 class="heading text-white fw-7">SẢN PHẨM MỚI</h5>
                            <button class="tf-btn btn-line btn-line-light collection-other-link fw-6"><span>XEM NGAY</span><i class="icon icon-arrow1-top-left"></i></button>
                        </div>
                    </div>
                </a>
            </div>
                    ...
                    <div class="card-product">
                        <div class="card-product-wrapper">
                            ...
                            <div class="on-sale-wrap text-end">
                                <div class="on-sale-item">-<?php echo $product['discount']; ?>%</div>
                            </div>
                        </div>
        ...
        <div class="tf-grid-layout md-col-2 tf-img-with-text style-5">
            <div class="d-flex gap-30">
                <div class="tf-image-wrap wow fadeInUp" data-wow-delay="0s">
                    <img class="lazyload" data-src="" src="public/img/anh5.jpg" alt="collection-img">
                </div>
                <div class="tf-image-wrap wow fadeInUp" data-wow-delay="0s">
                    <img class="lazyload" data-src="" src="public/img/anh6.jpg" alt="collection-img">
                </div>
            </div>
            <div class="tf-content-wrap wow fadeInUp" data-wow-delay="0s">
                <div class="sub-heading fw-7">GIỚI THIỆU</div>
                <div class="heading fw-7 fs-42">Những điều cần biết</div>
                <p class="description text_black-2 fs-16">Nike đang thể hiện sức mạnh của mình tại ComplexCon, thể hiện sự hiện diện của thương hiệu ở trung tâm văn hóa giày thể thao đồng thời mang đến cái nhìn độc đáo về sự giao thoa giữa đổi mới, văn hóa và thể thao trong tương lai.</p>
                <a href="shop-collection-list.html" class="tf-btn btn-line collection-other-link fw-6"><span>XEM CHI TIẾT</span><i class="icon icon-arrow1-top-left"></i></a>
            </div>
        </div>
    </div>
</section>
